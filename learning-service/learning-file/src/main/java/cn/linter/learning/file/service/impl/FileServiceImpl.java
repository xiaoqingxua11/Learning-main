...
public class FileServiceImpl implements FileService {
    ...
    @Value("${minio.work-file-bucket-name}")
    private String workFileBucketName;
    ...
    @Override
    public String uploadWorkFile(MultipartFile multipartFile) throws IOException, InvalidKeyException, InvalidResponseException, InsufficientDataException, NoSuchAlgorithmException, ServerException, InternalException, XmlParserException, ErrorResponseException {
        return saveMultipartFileWithRandomName(multipartFile, workFileBucketName);
    }
